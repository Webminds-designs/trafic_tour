...
const Sidebar = ({ activated }) => {
  ...
  return (
    <div className="w-72 h-screen bg-white flex flex-col justify-between p-7 font-figtree font-bold sticky top-0">
      <div>
        ...
        <ul className="space-y-8">
          <li>
            <Link
              to="/admin/dashboard"
              className={`flex items-center text-lg font-bold cursor-pointer transition-all duration-300 ${
                location.pathname === "/admin" ? "text-[#009990]" : "text-black"
              } hover:bg-[#ffffff]`}
            >
      ...
      <button
        onClick={logout}
        className="flex items-center text-red-900 text-lg font-bold cursor-pointer"
      >
