        ...
        <div className="flex mt-8">
          ...
          <div className="w-1/3 bg-white p-4 rounded-xl">
            ...
            {emails.map((inq) => (
              <div
                key={inq.id}
                className={`flex items-center gap-4 p-3 mb-1 rounded-lg cursor-pointer hover:bg-gray-100 transition ${
                  selectedInquiry?._id === inq._id ? "bg-gray-200" : ""
                }`}
                onClick={() => setSelectedInquiry(inq)}
              >
                <img
                  src={getGravatarUrl(inq.from)}
                  alt={inq.name}
