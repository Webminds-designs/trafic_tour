        ...
        <div className="fixed inset-0 bg-opacity-90 backdrop-blur-lg z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 md:p-8 lg:p-10 relative max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="text-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-base">{data.title}</h1>
                    <p className="text-black mt-2 text-sm sm:text-base md:text-lg font-base">03 NIGHTS | 04 DAYS TOUR</p>
                </div>
                ...
                <div className="flex justify-center mt-6 sm:mt-8 mb-4 space-x-2 sm:space-x-4">
                    {icons.map((icon, index) => (
                        <div key={index} className="bg-gray-300 rounded-full p-2 sm:p-3 md:p-4 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16">
                            <img src={icon.src} alt={icon.alt} className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8" />
                        </div>
                    ))}
                </div>
                        ...
                        {["INCLUDES", "CUSTOMISE", "PRICES"].map((tab) => (
                            <div
                                ...
                                className={`flex-1 text-center py-2 text-sm sm:text-base cursor-pointer transition-all duration-300 
                                    ${activeTab === tab ? 'bg-white text-[#009990] border-b-3 border-[#009990]' : ''}`}
                        ...
                        {activeTab === 'CUSTOMISE' && (
                            <div className="max-w-4xl mx-auto p-4 sm:p-6 rounded-lg flex flex-col lg:flex-row">
                                ...
                                <div className="flex-1 pr-0 lg:pr-6 mb-6 lg:mb-0">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="space-y-2 mt-2">
                                            {["Night Safari with Infrared Vision", "Birdwatching & Photography Tour", "Local Cooking Experience"].map((activity) => (
                                                <label key={activity} className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <span className="text-[#7F7F7F]">{activity} +12,000 LKR / +$40</span>
                                                </label>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea className="w-full bg-[#F4F5F5] p-3 rounded-md mt-2" placeholder="Enter your message here..."></textarea>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 pl-0 lg:pl-6">
                                    {/* Booking Details */}
                                    <div className="mb-4">
                                        <h2 className="text-black text-xl sm:text-2xl font-base mb-4 sm:mb-8">BOOKING DETAILS</h2>
                                        <div className="flex justify-between">
                                            <span className="text-black font-base">STANDARD PACKAGE</span>
                                    ...
                                    <div className="mb-4">
                                        <h2 className="text-black text-xl sm:text-2xl font-base mb-4 sm:mb-8">ACCOMMODATION UPGRADES</h2>
