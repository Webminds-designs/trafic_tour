...
>
      ...
      <div className="bg-gradient-to-b from-[#ffd78f] via-[#F6E7C9] to-white backdrop-blur-lg backdrop-brightness-75 bg-opacity-90 p-8 mt-20 rounded-3xl shadow-lg max-w-md w-full">
