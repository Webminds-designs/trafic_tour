      ...
      <div className="bg-gray-100 text-black font-sans">
        ...
        <header className="text-center py-10 md:py-20">
          ...
          >
            ...
            >
              Where every journey feels like a new discovery, blending nature,
              culture, and adventure in the heart of the island.
            </motion.p>
          </div>
          ...
          >
            <span className="relative inline-block">
              A
              <span className="absolute -top-4 left-1/2 -translate-x-1/2 text-5xl md:text-6xl lg:text-7xl">
                ˜
              </span>
            </span>
            yob
            <span className="relative inline-block">
              o
              <span className="absolute -top-1 left-1/2 -translate-x-1/2 text-5xl md:text-6xl lg:text-7xl">
                ˜
              </span>
            </span>
            wan
            ...
            {content.map((item, index) => (
              ...
              >
                ...
                <div className="w-full md:w-2/3 pl-0 md:pl-6 flex flex-col justify-center mt-4 md:mt-0">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-base mb-2 text-left">
                    {item.title}
                  </h2>
          ...
          <div className="flex flex-col lg:flex-row p-3 rounded-lg max-w-7xl w-full">
            ...
            >
              ...
              <p className="mt-4 text-black text-left leading-relaxed max-w-xl">
                Beyond the map, beyond the miles—travel is a feeling, a rhythm,
                a story waiting to unfold. From misty highlands to golden
                shores, we don’t just take you places—we awaken your sense of
                wonder. Whether you’re a soul that roams or a dreamer taking
                your first step, let’s journey together, discovering the magic
            ...
            {[
              {
                name: "Farzan Cader",
                img: voice2,
                title: "Chairman / Managing Directon",
              },
              {
                name: "Shahiq Cader",
                img: voice1,
              ...
              >
                ...
                <div className="text-center p-4">
                  ...
                  <h3 className="text-lg font-base">{person.title}</h3>
                </div>
              </motion.div>
            ))}
          </div>
